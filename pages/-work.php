		...
		<div class="frame">
			...
			<nav>
				<ul class="nav">
					...
					<li><a href="-work.php" class="link-list active">Work</a></li>
					<li><a href="-about.php" class="link-list">About</a></li></ul></nav>
			...
			<div class="tiles">
				<ul>
					...
					<li class="tile"><a href="shc.php#<>"><div class="overlay"></div><img src="../style/imgs/projects/shc/tile.png"/></a></li>
					<li class="tile"><a href="creative-progress.php#<>"><div class="overlay"></div><img src="../style/imgs/projects/creative-progress/tile.png"/></a></li>
					<li class="tile"><a href="traveler.php#<>"><div class="overlay"></div><img src="../style/imgs/projects/traveler/tile.png"/></a></li>
